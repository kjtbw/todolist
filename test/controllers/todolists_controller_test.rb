...
class TodolistsControllerTest < ActionController::TestCase
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post :create, todolist: { check: @todolist.check, deadline: @todolist.deadline, description: @todolist.description, title: @todolist.title }
    end
  ...
  test "should update todolist" do
    patch :update, id: @todolist, todolist: { check: @todolist.check, deadline: @todolist.deadline, description: @todolist.description, title: @todolist.title }
    assert_redirected_to todolist_path(assigns(:todolist))
  end
